...
// === CUSTOM EXCEPTION (Fully Implemented) ===
...
// === VEHICLE HIERARCHY (Fully Implemented) ===
...
// === PARKING SPOT HIERARCHY (Needs Completion) ===
...
// === TICKET & FEE CALCULATOR (Fully Implemented) ===
class Ticket {
...
// === CORE SYSTEM: PARKING LOT (Needs Completion) ===
class ParkingLot {
    ...
    public ParkingLot(FeeCalculator feeCalculator) {
        ...
        // TODO: Loop through all SpotType enum values.
    ...
    public Ticket parkVehicle(Vehicle vehicle) throws NoSpotAvailableException {
        ...
        // TODO: Iterate through the searchPath to find an available spot.
        ...
        throw new NoSpotAvailableException("Lot Full: No availabl spots for vehicle type "+vehicle.getType());
    ...
    public double processExit(Ticket ticket) {
        ...
        // TODO: Check if the spot exists and is NOT free.
        ...
        double fee=feeCalculator.calculateFee(ticket.getEntryTime());
        spot.removeVehicle();
        System.out.println("Vehicle leaving Spot "+spot.getSpotNumber());
        availableSpots.get(spot.getType()).add(spot);
        return fee;
    }
}
